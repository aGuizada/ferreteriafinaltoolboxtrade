  ...
  <div class="p-col-12 p-md-3 p-lg-2 p-mb-2">
    ...
    />
        ...
        <DataTable :value="arrayInventario" :rows="10" :rowsPerPageOptions="[5, 10, 20]"
          ...
          <Column v-for="col in columnas" :key="col.field" :field="col.field" :header="col.header" :body="col.body || null"></Column>
        </DataTable>
  
        <!-- Botón para abrir el modal de resumen -->
  ...
  export default {
    ...
    methods: {
      ...
      listarInventario(page, buscar, criterio) {
        const url = `/inventarios/itemLote/${this.tipoSeleccionado}?idAlmacen=${this.almacenSeleccionado}&buscar=${buscar}&criterio=${criterio}&page=${page}`;
